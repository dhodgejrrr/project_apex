...
2.  **Write the Executive Summary (Max 500 words):**
    *   Start by identifying the clear performance tiers: Leaders, Mid-field, and Laggers, naming the key teams and drivers and standout cars in each.
    *   Justify these placements with key data points (e.g., "Lewis Hamilton leads due to superior raw pace, backed by the best tire degradation model," or "Alliance is lagging, evidenced by the slowest average green-flag pace and high pit cycle loss.").
...
3.  **Develop 3 Tactical Recommendations:**
    *   These must be specific, data-driven, and reference car numbers or teams.
    *   Provide atleast **two** recommendations for a **leading team** to maintain their advantage.
    *   Provide atleast **two** recommendations for a **mid-field team** to gain a competitive edge.
    *   Provide atleast **two** recommendations for a **lagging team** to call attention to a fundamental weakness they have.
...
*   **Outlier Handling:** The significant pace deficit of the third driver in Car #64 (Ted Giovanis, `driver_deltas_by_car`) is an extreme outlier. Do not let this single data point heavily skew the overall analysis of Alliances competitive potential. Focus on the performance of the core competitive drivers in the car.
